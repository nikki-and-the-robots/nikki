...
addNikkiContacts :: MyCollisionType -> StorableArray Int Contact -> Double -> Contacts -> Contacts
addNikkiContacts ct contactArray coefficient c =
    c{nikkiContacts = ((ct, contactArray, coefficient) : nikkiContacts c)}
